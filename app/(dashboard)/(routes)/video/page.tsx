...
const VideoPage = () => {
  ...
  return (
    <div>
      <Heading title="Video Generation" description="Turn your story into video using prompts" icon={VideoIcon}  iconColor="text-orange-700" bgColor="bg-orange-700/10" />
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="rounded-lg border w-full p-4 px-3 md:px-6 focus-within:shadow-sm grid grid-cols-12 gap-2">
                    <FormField name="prompt" render={({field})=>(<FormItem className="col-span-12 lg:col-span-10">
                        <FormControl className="m-0 p-0">
                            <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent" disabled={isLoading} placeholder="Ninja fighting with robots with sabers from star wars." {...field} />
